export const TAIWAN_CITIES: Record<string, string[]> = {
    ...
    '新北市': [
        '板橋區', '新莊區', '中和區', '永和區', '土城區', '樹林區', '三峽區', '鶯歌區', '三重區', '蘆洲區', '五股區', '泰山區', '林口區', '八里區', '淡水區', '三芝區', '石門區', '汐止區', '萬里區', '金山區', '瑞芳區', '平溪區', '雙溪區', '貢寮區', '新店區', '深坑區', '石碇區', '坪林區', '烏來區'
    ],
    '桃園市': [
    ...
    '苗栗縣': [
        '苗栗市', '頭份市', '竹南鎮', '後龍鎮', '通霄鎮', '苑裡鎮', '卓蘭鎮', '造橋鄉', '西湖鄉', '頭屋鄉', '公館鄉', '銅鑼鄉', '三義鄉', '大湖鄉', '獅潭鄉', '泰安鄉', '南庄鄉', '三灣鄉'
    ],
    '彰化縣': [
        '彰化市', '員林市', '和美鎮', '鹿港鎮', '溪湖鎮', '二林鎮', '田中鎮', '北斗鎮', '花壇鄉', '芬園鄉', '大村鄉', '永靖鄉', '伸港鄉', '線西鄉', '福興鄉', '秀水鄉', '埔心鄉', '埔鹽鄉', '大城鄉', '芳苑鄉', '二水鄉', '社頭鄉', '田尾鄉', '埤頭鄉', '溪州鄉', '竹塘鄉'
    ],
    '南投縣': [
